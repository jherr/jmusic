...
const TopBar = tw.div`rounded-tr-3xl p-5 bg-white bg-opacity-60 sticky top-0`;

const ChordsContainer = tw.div`grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-6 gap-5 `;
